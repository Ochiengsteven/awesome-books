...
```sh
  cd my-folder
  git clone git@github.com:Ochiengsteven/awesome-books.git
```
...
If you like this project, create a pull request or hit us up on [Twitter](https://twitter.com/r_miyoyo) or [@Ochiengsteven](https://github.com/Ochiengsteven)
